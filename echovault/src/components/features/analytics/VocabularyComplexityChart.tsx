...
const VocabularyComplexityChart = () => {
  ...
  return (
    <Card>
      <div className="p-6">
        <h3 className="text-xl font-bold mb-4">Vocabulary Complexity</h3>
        {loading ? (
          <p>Loading data...</p>
        ) : data.length > 0 ? (
          <ResponsiveContainer width="100%" height={300}>
            <LineChart data={data}>
              ...
              <Tooltip 
                ...
                formatter={(value: number) => [value.toFixed(2), 'Complexity']}
              />
              <Line 
                type="monotone" 
...
export default VocabularyComplexityChart; 