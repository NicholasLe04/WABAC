...
export declare const ServerMessageStatusUpdateEndedReason: {
    ...
    readonly CallInProgressErrorProviderfaultTransportNeverConnected: "call.in-progress.error-providerfault-transport-never-connected";
    readonly CallInProgressErrorVapifaultWorkerNotAvailable: "call.in-progress.error-vapifault-worker-not-available";
    ...
    readonly PipelineErrorAnthropicBedrock400BadRequestValidationFailed: "pipeline-error-anthropic-bedrock-400-bad-request-validation-failed";
    readonly PipelineErrorAnthropicBedrock401Unauthorized: "pipeline-error-anthropic-bedrock-401-unauthorized";
    readonly PipelineErrorAnthropicBedrock403ModelAccessDenied: "pipeline-error-anthropic-bedrock-403-model-access-denied";
    readonly PipelineErrorAnthropicBedrock429ExceededQuota: "pipeline-error-anthropic-bedrock-429-exceeded-quota";
    readonly PipelineErrorAnthropicBedrock500ServerError: "pipeline-error-anthropic-bedrock-500-server-error";
    readonly PipelineErrorAnthropicBedrock503ServerOverloadedError: "pipeline-error-anthropic-bedrock-503-server-overloaded-error";
    readonly PipelineErrorAnthropicBedrockLlmFailed: "pipeline-error-anthropic-bedrock-llm-failed";
    readonly CallInProgressErrorVapifaultAnthropicBedrockLlmFailed: "call.in-progress.error-vapifault-anthropic-bedrock-llm-failed";
    readonly CallInProgressErrorVapifaultAnthropicBedrock400BadRequestValidationFailed: "call.in-progress.error-vapifault-anthropic-bedrock-400-bad-request-validation-failed";
    readonly CallInProgressErrorVapifaultAnthropicBedrock401Unauthorized: "call.in-progress.error-vapifault-anthropic-bedrock-401-unauthorized";
    readonly CallInProgressErrorVapifaultAnthropicBedrock403ModelAccessDenied: "call.in-progress.error-vapifault-anthropic-bedrock-403-model-access-denied";
    readonly CallInProgressErrorVapifaultAnthropicBedrock429ExceededQuota: "call.in-progress.error-vapifault-anthropic-bedrock-429-exceeded-quota";
    readonly CallInProgressErrorProviderfaultAnthropicBedrock500ServerError: "call.in-progress.error-providerfault-anthropic-bedrock-500-server-error";
    readonly CallInProgressErrorProviderfaultAnthropicBedrock503ServerOverloadedError: "call.in-progress.error-providerfault-anthropic-bedrock-503-server-overloaded-error";
    readonly PipelineErrorAnthropicVertex400BadRequestValidationFailed: "pipeline-error-anthropic-vertex-400-bad-request-validation-failed";
    readonly PipelineErrorAnthropicVertex401Unauthorized: "pipeline-error-anthropic-vertex-401-unauthorized";
    readonly PipelineErrorAnthropicVertex403ModelAccessDenied: "pipeline-error-anthropic-vertex-403-model-access-denied";
    readonly PipelineErrorAnthropicVertex429ExceededQuota: "pipeline-error-anthropic-vertex-429-exceeded-quota";
    readonly PipelineErrorAnthropicVertex500ServerError: "pipeline-error-anthropic-vertex-500-server-error";
    readonly PipelineErrorAnthropicVertex503ServerOverloadedError: "pipeline-error-anthropic-vertex-503-server-overloaded-error";
    readonly PipelineErrorAnthropicVertexLlmFailed: "pipeline-error-anthropic-vertex-llm-failed";
    readonly CallInProgressErrorVapifaultAnthropicVertexLlmFailed: "call.in-progress.error-vapifault-anthropic-vertex-llm-failed";
    readonly CallInProgressErrorVapifaultAnthropicVertex400BadRequestValidationFailed: "call.in-progress.error-vapifault-anthropic-vertex-400-bad-request-validation-failed";
    readonly CallInProgressErrorVapifaultAnthropicVertex401Unauthorized: "call.in-progress.error-vapifault-anthropic-vertex-401-unauthorized";
    readonly CallInProgressErrorVapifaultAnthropicVertex403ModelAccessDenied: "call.in-progress.error-vapifault-anthropic-vertex-403-model-access-denied";
    readonly CallInProgressErrorVapifaultAnthropicVertex429ExceededQuota: "call.in-progress.error-vapifault-anthropic-vertex-429-exceeded-quota";
    readonly CallInProgressErrorProviderfaultAnthropicVertex500ServerError: "call.in-progress.error-providerfault-anthropic-vertex-500-server-error";
    readonly CallInProgressErrorProviderfaultAnthropicVertex503ServerOverloadedError: "call.in-progress.error-providerfault-anthropic-vertex-503-server-overloaded-error";
    ...
    readonly PipelineErrorElevenLabsTranscriberFailed: "pipeline-error-eleven-labs-transcriber-failed";
    readonly CallInProgressErrorVapifaultElevenLabsTranscriberFailed: "call.in-progress.error-vapifault-eleven-labs-transcriber-failed";
    ...
    readonly CallForwardingOperatorBusy: "call.forwarding.operator-busy";
    ...
    readonly CallRingingHookExecutedSay: "call.ringing.hook-executed-say";
    readonly CallRingingHookExecutedTransfer: "call.ringing.hook-executed-transfer";
